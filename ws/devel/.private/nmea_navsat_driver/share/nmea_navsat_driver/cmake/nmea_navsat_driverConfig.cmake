...
if("TRUE" STREQUAL "TRUE")
  set(nmea_navsat_driver_SOURCE_PREFIX /home/xlqmu/ws/src/RMUC24_real/sensor_interface/nmea_navsat_driver)
  set(nmea_navsat_driver_DEVEL_PREFIX /home/xlqmu/ws/devel/.private/nmea_navsat_driver)
  ...
  set(nmea_navsat_driver_INSTALL_PREFIX /home/xlqmu/ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nmea_navsat_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xlqmu/ws/src/RMUC24_real/sensor_interface/nmea_navsat_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/xlqmu/ws/devel/.private/nmea_navsat_driver/lib;/home/xlqmu/ws/devel/lib;/home/xlqmu/navigation_2023/devel/.private/catkin_tools_prebuild/lib;/home/xlqmu/catkin_ws/devel/lib;/opt/ros/noetic/lib)
